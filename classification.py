...
# Load your dataset
df = pd.read_csv("E:/MiniProjectSem3/MINI_PROJECT/Data/Data(2).csv")  # Replace with the actual path to your dataset
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig("E:/MiniProjectSem3/MINI_PROJECT/accuracy_plot.png")

# Save the trained model, tokenizer, and label encoder using torch.save
output_dir = "E:/MiniProjectSem3/MINI_PROJECT"
